    ...
    <main>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="container2">
                    ...
                    <ol>
                        ...
                        <ul>
                            ...
                            <li> droit : Utilisé pour ouvrir des menus contextuels et des options supplémentaires. Un clic droit sur un élément ouvre souvent un menu avec des actions possibles.</li>
                        ...
                        <ul>
                            ...
                            <li>Double-clic : Appuyez rapidement deux fois de suite sur le bouton gauche pour ouvrir un fichier ou un dossier.</li>
                            <li>Clic droit : Appuyez une fois sur le bouton droit pour ouvrir un menu contextuel avec des options supplémentaires.</li>
                        ...
                        <ul>
                            ...
                            <li>Déplacer l'élément : Faites glisser la souris tout en maintenant le bouton gauche enfoncé pour déplacer l'élément.</li>
                        ...
                        <ul>
                            ...
                            <li>Défilement horizontal : Certaines souris ont une fonction de défilement horizontal accessible en inclinant la molette ou en utilisant un bouton spécifique.</li>
                ...
                <p class="lienPDF">Vous retrouverez tout cela en détail dans le fichier "bases_ordinateur" du sous-menu "Ordinateur" de l'onglet "PDF à télécharger"</p>
