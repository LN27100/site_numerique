...
<body>
    ...
    <div class="container">
        <div class="row">
            <p>Vous trouverez ci-dessous des exercices à effectuer sur un logiciel de traitement de texte tel que Word, LibreOffice etc.</p>

            <!-- Liste des pdf à télécharger -->
            <?php if (count($pdfs) > 0) : ?>
                <ul>
                    <?php
                    $uploadDir = '../assets/pdf/exercices/traitement_texte/';
